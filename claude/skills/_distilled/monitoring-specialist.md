---
name: distilled-context-monitoring-specialist
description: Contexto Helix comprimido para monitoring-specialist. Auto-generado — no editar manualmente.
...
# Contexto Helix — monitoring-specialist
