---
name: distilled-context-error-detective
description: Contexto Helix comprimido para error-detective. Auto-generado — no editar manualmente.
...
# Contexto Helix — error-detective
