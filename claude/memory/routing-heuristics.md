...
> Generado: 2026-04-12 12:50 | Entradas analizadas: 56
...
- **Usados 1 vez**: Explore, api-security-audit, app-creative-genius, data-analyst, fin-saas-advisor, security-auditor, ui-designer

---
*Actualizar con: `bash ~/.claude/helpers/helix-erl.sh`*

## Reglas ExpeL (Contrastivas)
> Generado: 2026-04-12 12:50 | Basado en 56 trayectorias
