...
- "la base de datos está lenta", "tarda mucho la consulta"
- "performance de la DB", "timeout en la query"
- "cómo mejorar este select", "está tardando en cargar"
- "muchos registros y va lento", "agregar índice a tabla"
- "reportes lentos", "filtros que no escalan"