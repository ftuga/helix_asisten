...
- "algo está fallando", "no sé qué pasa", "hay un error raro"
- "me tiró un error", "cayó la app", "no carga"
- "bug en producción", "algo se rompe en ciertas condiciones"
- "traceback", "stacktrace", "exception no esperada"
