...
echo ""
echo "  # Ecosistema RuFlo v3.5.41 (https://github.com/ruvnet/ruflo)"
echo "  npx ruflo --version                # verificar versión (debe ser 3.5.41+)"
echo "  claude mcp add claude-flow -- npx -y @claude-flow/cli@latest mcp start"
echo "  npx agentic-flow@alpha --version   # calentar caché ONNX embeddings"
echo ""
echo "  # Otros MCPs"
